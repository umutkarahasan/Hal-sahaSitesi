...
<div class="profil">
    ...
    <div class="sag">
        <form action='guncels.php' method="post">
            <table width="700"   height="150" ">
            <tr>

                <td><input type="hidden" id="sahadi" name="id"  value="<?php echo $saha['saha_id']?>" "></td>
            </tr>
            <tr>
                <td><label id="saha">SAHA ADI : </label> </td>
                <td><input type="text" id="sahadi" name="sahaadi"  value="<?php echo $saha['saha_name']?>" "></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="number" min="0" max="1" id="tel" name="durum" value="<?php echo $saha['durum']?>" "></td>
